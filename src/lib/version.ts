// Versão exibida no badge do header e no /debug.
// REGRA FIXA: nunca subir para "v1.0" (ou Beta) sem autorização EXPLÍCITA do usuário.
...
export const APP_VERSION = "Alpha v0.11";
